                  ...
                  <div className='t-content ex-content'>
                    <div className='d-flex align-item-center'>
                      <div className='t-content-title'>
                        ...
                        <h5><a href='https://acquaintsoft.com/'>Acquaint Softtech Private Limited</a></h5>
                      </div>
                  ...
                  <div className='t-content ex-content'>
                    <div className='d-flex align-item-center'>
                      <div className='t-content-title'>
                        ...
                        <h5><a href="https://www.codecaste.com/"> CodeCaste Pvt Ltd</a></h5>
                      </div>
                      <div className='t-btn ex-btn text-center'>
